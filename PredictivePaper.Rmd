...
legend(2012, 850, c("L R-sq = .77 ", "Q R-sq = .76", "S Rs-sq = .77"), lty = c(1,1,1), lwd = c(2,2,2), col = c("blue", "green", "orange"), bty = "n" )
...
legend(2012, 425, c("L R-sq = 61", "Q R-sq = 0.60", "S R-sq = 0.68"), 
...
legend(2012, 220, c("L R-sq = .73", "Q R-sq = .79", "S R-sq = .74"), lty = c(1,1,1), lwd = c(2,2,2), col = c("blue", "green", "orange"), bty = "n" )
...
All of this leads us to veer in the direction of choosing forecasting models that accomodate trend and seasonality for all but one of the SKUs, M. However. looking at the M plots that show trend and seasonality, it seems that those components are present and I therefore think it's worth trying to model with methods other than the naive. 

###Step 3 

Forecast with the appropriate models. Also include a naive model to use as a baseline. 
...
plot(e.ts, main = "Smoothing Model E", bty = "l")
lines(etsE$fitted, col = "blue", lty = 1,lwd = 2)
...
```{r}
validationPeriod <- as.Date("05-16", "06-16", "07-16", "08-16","09-16", "10-16", "11-16", "12-16","01-17", "02-17", "03-17", "04-17")
