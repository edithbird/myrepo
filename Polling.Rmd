...
d <- ggplot(data = YouCitizenMonkey, aes(x = date, y = approve, group = poll, color = poll)) + geom_line(size=1) + geom_point() + facet_wrap(~ poll) + geom_smooth(method = "lm", color = "grey", se = FALSE)
