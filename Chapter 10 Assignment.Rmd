...
plot(c(1980, 1995), c(1000, 6000), type = "n", xlab = "Year", ylab = "Sales", bty = "l", xaxt = "n", yaxt = "n")
lines(Fortified.ts, col = "blue", lwd = 2)
axis(1, at = seq(1980, 1995, 1))
...
legend(1990, 5900, c("Actual Sales", "NN Model"), lty = c(1, 2), lwd = c(1,2), col = c("blue", "red"))
```
