...
lines(fortified.nn$fitted, lty = 2, col = "deeppink4", lwd = 2)
legend(1987, 5900, c("Actual Sales", "NN Model MAPE = 2.06%"), lty = c(1, 2), lwd = c(1,2), col = c("blue", "deeppink4"), bty = "n")
```
...
plot(c(1994, 1995), c(1000, 6000), type = "n", xlab = "Month", ylab = "Sales", bty = "l", xaxt = "n", yaxt = "n", main = "Air Travel in 1994 \nActual and Forecasted Values")
lines(FortifiedsalesValid, col = "blue", lwd = 2)

axis(1, at=seq(1994,1995,1/11),labels=c("Jan","Feb","Mar","Apr","May","Jun","Jul", "Aug","Sep","Oct","Nov","Dec"), xaxs = "r")
axis(2, at = seq(1000, 6000, 500), labels = format(seq(1000, 6000, 500)))
lines(fortifiedForecast$mean, lty = 2, col = "deeppink4", lwd = 2)
lines(fortified.ets.forecast$mean, lty = 3, lwd = 3)
legend(1994+1/11, 5900, c("Actual Sales", "NN Model Forecast", "Smoothing Forecast"), lty = c(2, 2, 3), lwd = c(1,2, 3), col = c("blue", "deeppink4", "black"), bty = "n")
