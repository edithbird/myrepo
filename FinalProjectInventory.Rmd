...
```{r}
x <- inner_join(Stock12, Stock13, by = "Item_Code")
head(x)
dim(x)
x[16000,]
```
...
write.csv(Stock12, "Stock12.csv", row.names = F)
write.csv(Stock13, "Stock13.csv", row.names = F)
write.csv(Stock14, "Stock14.csv", row.names = F)
write.csv(Stock15, "Stock15.csv", row.names = F)
write.csv(Stock16, "Stock16.csv", row.names = F)
write.csv(Stock17, "Stock17.csv", row.names = F)
```
